...
const honey_model_1 = require("../modules/honey/honey.model");
const clothing_model_1 = require("../modules/clothing/clothing.model");
...
const seedProducts = async () => {
    try {
        // Clear collections
        await honey_model_1.Honey.deleteMany({});
        logger_1.default.info('🗑️ Cleared existing Honey products.');
        await clothing_model_1.Clothing.deleteMany({});
        logger_1.default.info('🗑️ Cleared existing Clothing products.');
        await cart_model_1.Cart.deleteMany({});
        logger_1.default.info('🗑️ Cleared existing carts.');
        // Seed Honey
        await honey_model_1.Honey.insertMany(honeyProducts);
        logger_1.default.info(`✅ ${honeyProducts.length} Honey products seeded.`);
        // Seed Clothing
        await clothing_model_1.Clothing.insertMany(clothingProducts);
        logger_1.default.info(`✅ ${clothingProducts.length} Clothing products seeded.`);
    }
    catch (error) {
